...
export function LightPullThemeSwitcher() {
  ...
  return (
    <div className="flex flex-col items-center justify-center fixed top-4 right-4 z-50 gap-2 text-xs text-foreground font-medium select-none">
    ...
    >
      <div className="flex flex-col items-center text-center leading-tight tracking-tight">
         <ChevronDown/> Pull down to change theme
      </div>
    </motion.div>
    </div>
  )
